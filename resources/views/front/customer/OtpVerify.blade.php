                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 col-xl-6 order-xl-2">
                                <div class="card-body p-4 p-sm-5">
                                    <h5 class="card-title px-5">Otp Verification</h5>
                                    <p class="card-text mb-4 px-5">You have received an email which contains Otp Verification code.</p>
                                    ...
                                    <form class="form-body px-5" method="POST"
                                          action="{{ route('customer.helpdesk.register.OtpSuccess') }}">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-12 ">
                                                ...
                                                <div class="ms-auto position-relative">
                                                    ...
                                                    <input type="text" class="form-control radius-30 ps-5" name="otp"
                                                           id="otp" placeholder="Enter Otp Code" autofocus>
                                                    @error('otp')
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary radius-30">Verify Otp</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
