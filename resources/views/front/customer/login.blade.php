...
<head>
    ...
    <title>Best Legal Services - Customer Login</title>
</head>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 col-xl-6 order-xl-2">
                                <div class="card-body p-4 p-sm-5">
                                    ...
                                    @endif
                                    <h5 class="card-title px-3">Sign In</h5>
                                    <p class="card-text mb-4 px-3">See your growth and get consulting support!</p>
                                    <form class="form-body px-3" method="POST"
                                          action="{{ route('customer.helpdesk.login.create') }}">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary radius-30" onclick="submitForm(this);">Sign
                                                        In</button>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 text-center">
                                                <p class="mb-0">Don't have an account yet? <a
                                                       href="{{ route('customer.helpdesk.register') }}" class="font-weight-bold">Sign Up</a></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
