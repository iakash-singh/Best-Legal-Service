        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header py-3 bg-transparent">
                    <h5 class="mb-0">{{ trans('admin.posts.create') }}</h5>
                </div>
                <div class="card-body">
                    <div class="border p-3 rounded">
                        <form class="row g-3" method="POST" action="{{ route('admin.Blog.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-6">
                                <label class="form-label">Featured Image <strong>(Image Size: 736px by 490px)</strong> <span class="text-danger">*</span></label>
                            ...
                            <div class="col-6">
                                ...
                                <select class="multiple-select" name="tags[]" data-placeholder="Choose Tags" multiple="multiple">
                                    @foreach ($tags as $tag)
                            ...
                            <div class="col-6">
                                ...
                                <select class="multiple-select" name="categories[]" data-placeholder="Choose Categories" multiple="multiple">
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="editor" name="body" class="ckeditor form-control" placeholder="Description" rows="4" cols="4">{{ old('body') }}</textarea>
                                @error('body')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="border p-3 rounded">
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('admin.Blog.index') }}" class="btn btn-secondary px-4">{{ trans('admin.buttons.cancel') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
