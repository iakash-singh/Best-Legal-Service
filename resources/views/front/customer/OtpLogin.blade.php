                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 col-xl-6 order-xl-2">
                                <div class="card-body p-4 p-sm-5">
                                    <h5 class="card-title px-5">Otp Login Verification</h5>
                                    <p class="card-text mb-4 px-5">You have received an email which contains Otp Verification code to Login.</p>
                                    ...
                                    <form class="form-body px-5" method="POST"
                                          action="{{ route('customer.helpdesk.login.OtpSuccess') }}">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-12 ">
